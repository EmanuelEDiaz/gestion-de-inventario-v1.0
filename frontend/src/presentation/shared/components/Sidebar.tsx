...
import { 
  LayoutDashboard, Package, PackageOpen, 
  Store, Truck, Database, Settings 
} from 'lucide-react';
...
const sectionIcons: Record<string, { closed: React.ReactNode; open: React.ReactNode }> = {
  general: { closed: <LayoutDashboard size={20} />, open: <LayoutDashboard size={20} /> },
  inventario: { closed: <Package size={20} />, open: <PackageOpen size={20} /> },
  comercial: { closed: <Store size={20} />, open: <Store size={20} /> },
  operaciones: { closed: <Truck size={20} />, open: <Truck size={20} /> },
  datos: { closed: <Database size={20} />, open: <Database size={20} /> },
  sistema: { closed: <Settings size={20} />, open: <Settings size={20} /> },
};
      ...
      <nav className="flex-1 overflow-y-auto p-2">
        <ul>
          {sections.map((section) => {
            const icons = sectionIcons[section.id] || { closed: <Package size={20} />, open: <Package size={20} /> };
