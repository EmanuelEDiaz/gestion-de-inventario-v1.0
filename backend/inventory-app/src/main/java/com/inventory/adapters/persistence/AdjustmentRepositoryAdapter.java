...
import com.inventory.adapters.persistence.mapper.AdjustmentEntityMapper;
import com.inventory.adapters.persistence.repository.R2dbcAdjustmentLineRepository;
import com.inventory.adapters.persistence.repository.R2dbcAdjustmentRepository;
...
public class AdjustmentRepositoryAdapter implements AdjustmentRepository {
    ...
    private Mono<Adjustment> loadWithLines(com.inventory.adapters.persistence.entity.AdjustmentEntity entity) {
