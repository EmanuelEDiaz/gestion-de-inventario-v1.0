...
import com.inventory.adapters.persistence.mapper.ReturnEntityMapper;
import com.inventory.adapters.persistence.repository.R2dbcReturnLineRepository;
import com.inventory.adapters.persistence.repository.R2dbcReturnRepository;
...
public class ReturnRepositoryAdapter implements ReturnRepository {
    ...
    private Mono<Return> loadWithLines(com.inventory.adapters.persistence.entity.ReturnEntity entity) {
